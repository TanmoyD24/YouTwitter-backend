...
const registerUser = asyncHandler(async (req, res) => {
    ...
    // check for images, cleck for avatar
    // upload them to coludinary, avatar
    // create user object - create entry id in db
    ...
    console.log("DEBUG REQ.BODY:", { fullName, email, username, password });
    ...
    // console.log("DEBUG CLOUDINARY AVATAR OBJ:", avatar);
    // console.log("DEBUG CLOUDINARY COVER OBJ:", coverImage);
...
const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (!user) {
            throw new ApiError(401, "Invaslid refresh token");
        }
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, "User channel feteched successfully")
        )
});
